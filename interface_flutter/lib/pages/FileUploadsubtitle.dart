...
class FileUploadsubtitle extends StatefulWidget {


  @override
  State<FileUploadsubtitle> createState() => _FileUploadsubtitleState();
}

class _FileUploadsubtitleState extends State<FileUploadsubtitle> {
            ...
            children: [
                ...
                child: DottedBorder(
                  ...
                  child: BlocConsumer<pieckvideocubite, pieckVideoStates>(
                    builder: (context, state) {
                      ...
                      else if (state is pieckVideoloading ||
                          state is UplodVideoLoadingState) {
                        return Center(
                          child: SizedBox(
                            height: 120,
                            width: 120,
              ...
              Row(
                ...
                children: [
                  ...
                  BlocBuilder<pieckvideocubite, pieckVideoStates>(
                    builder: (context, state) {
                      if(state is pieckVideosuccees){
                        return ElevatedButton(
                          ...
                          onPressed: () {
                            BlocProvider.of<pieckvideocubite>(context)
                                .uplodVideo();
                          },
                          child: Text("Video Subtitle"),
                        );

                      }
                      else if(state is  UplodVideoLoadingState) {
                        return Container(
